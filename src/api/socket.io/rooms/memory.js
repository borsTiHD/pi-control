...
import Memory from '../../controllers/getMemory.js' // Root dir of API Folder

// Room Event name
const eventName = 'memory'
    ...
    function initialize(duration) {
        ...
        async function getData() {
            try {
                ...
                io.to(roomName).emit(eventName, { _status: 'error', error: error.message, info: 'Error on getting memory usage' })
            }
        }
